...
const reports = [
  {
    id: '1',
    type: 'post',
    content: 'Inappropriate content in discussion forum post about cardiac procedures...',
    reportedItem: {
      type: 'Post',
      title: 'My experience with TAVR complications',
      author: 'Dr. Anonymous123',
    },
    reporter: 'User Name',
    ...
    details: 'The post contains medically inaccurate information about TAVR procedure risks that could mislead other medical professionals.',
  },
  {
    id: '2',
    type: 'comment',
    content: 'Offensive language in comment section...',
    reportedItem: {
      type: 'Comment',
      title: 'Re: Best practices for stent placement',
      author: 'CardioDoc99',
    },
    reporter: 'User Name',
    reason: 'Harassment',
    ...
    details: 'User made derogatory comments towards another member\'s medical opinion.',
  },
  {
    id: '3',
    type: 'profile',
    content: 'Suspicious profile with fake credentials...',
    reportedItem: {
      type: 'Profile',
      title: 'Dr. FakeDoctor',
      author: 'FakeDoctor',
    ...
    details: 'Automated system detected inconsistencies in credential verification documents.',
  },
  {
    id: '4',
    type: 'media',
    content: 'Copyrighted medical image used without permission...',
    reportedItem: {
      type: 'Image',
      title: 'Coronary angiogram diagram',
      author: 'Dr. Elena K.',
    },
    reporter: 'Copyright Bot',
    reason: 'Copyright',
    severity: 'low',
    status: 'resolved',
    reportedAt: '3 days ago',
    details: 'Image appears to be from a copyrighted medical textbook without proper attribution.',
    resolution: 'User was notified and replaced the image with properly licensed content.',
  },
  {
    id: '5',
    type: 'post',
    ...
    reportedItem: {
      type: 'Post',
      title: 'AMAZING COURSE - 50% OFF!!!',
      author: 'SpammerAccount',
    },
    ...
    details: 'Multiple users reported this post as spam promoting unauthorized external courses.',
    resolution: 'Account banned and content removed.',
  },
];
